    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="surface-card-lg backdrop-blur-xl rounded-3xl p-8">
        ...
        <div className="space-y-4 text-coffee-espresso/80 leading-relaxed">
          <p>
            Кофемания VPN — это свобода в интернете без компромиссов. Никаких блокировок, никаких
            обрывов — просто стабильное и быстрое соединение, которое работает всегда и везде.
          </p>
          <p>
